...
class ConfigReader:
    ...
    def read_config(self):
        ...
        if value >= 1.0:
            self.aim_smoothing_factor = value  # UCA style: 1.0 = snap, 1.5 = default, 3.0+ = smooth
        else:
            print('WARNING: aim_smoothing_factor must be >= 1.0 (UCAimColor style)')
            self.aim_smoothing_factor = 1.5  # Default to UCA's default
